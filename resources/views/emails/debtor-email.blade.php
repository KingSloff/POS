    ...
    <tr>
        <td>
            ...
            <table cellpadding="0" cellspacing="0" border="0" align="center">
                <tr>
                    <td valign="top">Hi {{$user->name}}, jou snoepie skuld is {{$services->displayCurrency( abs($user->balance))}}.</td>
                </tr>
                <tr>
                    <td valign="top"></td>
                </tr>
                <tr>
                    <td valign="top">Groete</td>
                </tr>
                <tr>
                    <td valign="top">Raddix POS stelsel</td>
                </tr>
            </table>
